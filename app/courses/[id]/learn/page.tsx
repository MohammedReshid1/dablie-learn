  ...
  return (
    <div className="flex flex-col h-screen bg-white">
      ...
      <div className="flex-1 flex overflow-hidden">
        <main className="flex-1 overflow-y-auto">
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-4">
              <div className="flex items-center justify-between text-white">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-white/70">22:35</span>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  <Button variant="ghost" size="icon" className="text-white hover:bg-white/20">
              ...
              <div className="mt-2">
                <div className="h-1 bg-white/30 rounded-full overflow-hidden">
                  <div className="h-full bg-rose-500 w-[56%]" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="p-6">
            <Tabs defaultValue="overview">
              ...
              <TabsContent value="notes" className="min-h-[200px]">
              ...
              <TabsContent value="resources" className="space-y-4">
                <div className="border rounded-lg p-4 flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    <div>
                      <div className="font-medium">JavaScript Variables Cheat Sheet</div>
                      <div className="text-sm text-neutral-500">PDF, 256KB</div>
                    </div>
                  </div>
                ...
                <div className="border rounded-lg p-4 flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-neutral-500">ZIP, 1.2MB</div>
                    </div>
                  </div>
                  <Button variant="outline" size="sm">
                    <Download className="h-4 w-4 mr-2" />
              ...
              <TabsContent value="transcript" className="space-y-4">
                <div className="border rounded-lg p-4">
                  ...
                  <p className="text-neutral-600 leading-relaxed mt-4">[Transcript continues...]</p>
                </div>
              </TabsContent>
            </Tabs>
          </div>
        ...
        {sidebarOpen && (
          <aside className="w-full md:w-80 lg:w-96 border-l overflow-y-auto flex-shrink-0">
            <div className="p-4 border-b">
              <div className="flex items-center justify-between mb-2">
                <h2 className="font-bold">Course Content</h2>
                <div className="text-sm text-neutral-500">65% complete</div>
              </div>
            ...
            <div className="divide-y">
              {course.sections.map((section) => (
                <div key={section.id} className="py-2">
                  <div
                    className={`flex items-center justify-between px-4 py-2 cursor-pointer hover:bg-neutral-50 ${
                      section.id === "4" ? "bg-neutral-50" : ""
                    }`}
                  >
                    <div className="flex items-center">
                      <ChevronDown className="h-5 w-5 mr-2 text-neutral-500" />
                      <div>
                    ...
                    {section.lectures.map((lecture) => (
                      <div
                        ...
                        className={`flex items-center justify-between px-2 py-2 rounded-md ${
                          lecture.current ? "bg-rose-50" : lecture.completed ? "text-neutral-500" : ""
                        }`}
                      >
                        <div className="flex items-center">
                          {lecture.type === "video" ? (
                            <Play className={`h-4 w-4 mr-2 ${lecture.current ? "text-rose-600" : ""}`} />
                          ...
                          <span className={lecture.current ? "font-medium text-rose-600" : ""}>{lecture.title}</span>
                        </div>
                        <div className="flex items-center">
                          <span className="text-xs mr-2">{lecture.duration}</span>
                          {lecture.completed && (
